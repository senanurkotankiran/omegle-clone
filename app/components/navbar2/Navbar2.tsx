  ...
  return (
    <nav className="flex flex-col md:flex-row w-full items-center justify-right px-3 cursor-pointer px-r md:px-10 h-auto md:h-14 text-black bg-gradient-to-r from-gray-800 via-gray-800 to-gray-800 space-y-4 md:space-y-0  md:space-x-16 font-sans text-sm font-bold text-white mt-4 md:mt-0">
     ...
     {/*  <div className="relative flex items-center ">
        <div className={`px-r flex items-center cursor-pointer  hover:bg-white hover:opacity-50 hover:p-1 hover:text-black  hover:rounded-lg ${active === 'chatlist' ? 'transition ease-in-out hover:-translate-y-1 duration-300 text-white rounded-lg p-1  flex items-center justify-center ' : ''}`} onClick={() => handleClick('chatlist')}>
          <ChatList />
